...
```{r results='asis', fig.height=6, fig.width=10, warning=FALSE}
...
```{r tab.cap="Variability of ranks of sample points between models measured as the mean standard deviation of rank across the sampled cells."}
...
```
```{r tab.cap="Comparison of model performance on validation data set. Note that the model predictions are not all in the same units but we might still expect them to be related. Not sure what the best way to address this is."}
